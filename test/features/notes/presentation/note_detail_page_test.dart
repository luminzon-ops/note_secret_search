...
void main() {
  testWidgets(
    'NoteDetailPage shows enhanced search handoff card when opened from search',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            noteDetailProvider(
              'note-1',
            ).overrideWith((ref) async => _fakeNote()),
          ],
  ...
  testWidgets(
    'NoteDetailPage shows unified semantic-hit label for semantic search entry',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'NoteDetailPage shows content-focused guidance when search context targets content',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'NoteDetailPage shows semantic-only handoff explanation for retained semantic result',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets('NoteDetailPage hides search handoff card when opened directly', (
    tester,
  ) async {
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: const MaterialApp(home: NoteDetailPage(noteId: 'note-1')),
      ),
    );
  ...
  testWidgets(
    'NoteDetailPage highlights summary block when search context targets summary',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'NoteDetailPage highlights content block when search context targets content',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'NoteDetailPage does not highlight any block for unknown search context',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
