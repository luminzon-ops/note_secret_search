...
void main() {
  testWidgets(
    'SecretDetailPage shows enhanced search handoff card when opened from search',
    (tester) async {
        ...
        ProviderScope(
          overrides: [
            ...
            secretDetailProvider(
              'secret-1',
            ).overrideWith((ref) async => _fakeSecret()),
          ],
  ...
  testWidgets(
    'SecretDetailPage shows note-focused guidance when search context targets note',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'SecretDetailPage shows semantic-only handoff explanation for retained semantic result',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'SecretDetailPage hides search handoff card when opened directly',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'SecretDetailPage highlights username row when search context targets account',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'SecretDetailPage highlights note row when search context targets note',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
  ...
  testWidgets(
    'SecretDetailPage does not highlight any row for unknown search context',
    (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
