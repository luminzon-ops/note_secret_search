...
final modelRegistryEntriesProvider =
  ...
  return guardSensitiveFuture<List<ModelRegistryEntry>>(
    ...
    load: () async {
      ...
      final catalogEntries =
          await ref.watch(modelCatalogEntriesProvider.future);
      ...
      for (final entry in entries) {
        ...
        var normalized = entry.copyWith(
          ...
          integrityStatus:
              present ? entry.integrityStatus : ModelIntegrityStatus.unknown,
        );
...
final modelDownloadTasksProvider =
    FutureProvider<List<ModelDownloadTask>>((ref) {
...
final modelDownloadControllerProvider =
    Provider<ModelDownloadController>((ref) {
